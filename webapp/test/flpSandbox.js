		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Opa Tests",
									"targetURL": "#cpfcomsaptrainingux402opaux402opa-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cpfcomsaptrainingux402opaux402opa-display": {
								"semanticObject": "cpfcomsaptrainingux402opaux402opa",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cpf.com.sap.training.ux402.opa.ux402opa",
									"url": sap.ui.require.toUrl("cpf/com/sap/training/ux402/opa/ux402opa")
								}
							}
						}
					}
